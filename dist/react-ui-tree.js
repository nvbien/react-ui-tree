...
var _initialiseProps = function _initialiseProps() {
  ...
  this.drag = function (e) {
    ...
    if (newIndex) {
      ...
      _this2.setState({
        indexDrag: newIndex,
        parentIndexDrag: tree.getIndex(newIndex.parent)
      });
    }
  ...
  this.dragEnd = function () {
    ...
    _this2.change(_this2.state.tree, _this2.state.indexDrag, _this2.state.parentIndexDrag);
    window.removeEventListener('mousemove', _this2.drag);
    window.removeEventListener('mouseup', _this2.dragEnd);
  };

  this.change = function (tree, indexDrag, parentIndexDrag) {
    _this2._updated = true;
    if (_this2.props.onChange) _this2.props.onChange(tree.obj, indexDrag, parentIndexDrag);
  };
